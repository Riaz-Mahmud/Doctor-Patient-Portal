		...
		<table border="1" align="center" cellspacing="5" cellpadding="5" width="100% id=" request">
			...
			<?php for ($i = 0; $i != count($doctorrequests); $i++) { ?>
				...
				<tr>
					...
					<!-- <td style="display:none;"><input type="text" name="d_id" value="<?= $doctorrequests[$i]['d_id'] ?>"></td> -->
					...
					<td>
						...
						<form action="approval.php" method="POST">
							<input type="hidden" name="d_id" value="<?= $doctorrequests[$i]['d_id'] ?>">
						<input type="submit" class="btn btn-warning" value="Approval" name="approval" id="">
						</form>

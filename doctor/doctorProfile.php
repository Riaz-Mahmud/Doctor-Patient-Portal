...
if (isset($_POST['infoUpdate'])) {
    ...
    if (empty($_POST['visitendedit'])) {
        ...
        $query = "UPDATE `doctor` SET `d_fname`='$_POST[fname]',`d_lname`='$_POST[lname]',`d_dob`='$_POST[dob]',`d_bgroup`='$_POST[bGroup]',`d_email`='$_POST[email]',`d_phone`='$_POST[pNumber]' ,`d_department`='$_POST[dept]',`d_hospital`='$_POST[hospital]' WHERE `d_name` = '$user';";

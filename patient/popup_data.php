...
<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="doc_inst" readonly value="<?php echo $rows['d_hospital']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="p_phn" readonly value="<?php echo $userRow['p_phone']; ?>">
                        </div>

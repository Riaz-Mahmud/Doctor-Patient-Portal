        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <select class="form-control" name="accountType" id="drpdwnDept" onchange="deptSearch()">
                    ...
                    <option value="DEPARTMENT OF EYE" >DEPARTMENT OF EYE</option>
                                ...
                                <option value="DEPARTMENT OF CARDIO THORACIC" >DEPARTMENT OF CARDIO THORACIC</option>
                                <option value="DEPARTMENT OF ANAESTHETIST" >DEPARTMENT OF ANAESTHETIST</option>
                                <option value="DEPARTMENT OF GENERAL MEDICINE & HEART" >DEPARTMENT OF GENERAL MEDICINE & HEART</option>
                                <option value="DEPARTMENT OF SKIN" >DEPARTMENT OF SKIN</option>
                                <option value="DEPARTMENT OF DENTAL" >DEPARTMENT OF DENTAL</option>
                                <option value="DEPARTMENT OF ORTHOPAEDICS" >DEPARTMENT OF ORTHOPAEDICS</option>
                                <option value="DEPARTMENT OF NEPHROLOGY" >DEPARTMENT OF NEPHROLOGY</option>
                                <option value="DEPARTMENT OF NEUROLOGY" >DEPARTMENT OF NEUROLOGY</option>
                                <option value="DEPARTMENT OF GYNAECOLOGY" >DEPARTMENT OF GYNAECOLOGY</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="accountType" id="drpdwnHospital" onchange="hospitalSearch()">
                    ...
                    <option value="Square Hospital" >Square Hospital</option>
                                ...
                                <option value="BSMMU Hospital">BSMMU Hospital</option>
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td><strong><?php echo $rows['d_fname']; ?> <?php echo $rows['d_lname']; ?></strong><br>
                                ...
                                <?php echo $rows['d_department']; ?><br>
                                <?php echo $rows['d_hospital']; ?></td>
                            <td>
